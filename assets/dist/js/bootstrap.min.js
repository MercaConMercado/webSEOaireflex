    ...
    E = function () {
      ...
      return n.next = function () {
        ...
        this._config.keyboard && e(this._element).on("keydown.bs.carousel", (function (e) {
          return t._keydown(e)
        })), "false" === this._config.pause && e(this._element).on("mouseenter.bs.carousel", (function (e) {
          return t.pause(e)
        ...
        if (this._touchSupported) {
          var n = function (e) {
            ...
            i = function (e) {
              t._pointerEvent && y[e.originalEvent.pointerType.toUpperCase()] && (t.touchDeltaX = e.originalEvent.clientX - t.touchStartX), t._handleSwipe(), "false" === t._config.pause && (t.pause(), t.touchTimeout && clearTimeout(t.touchTimeout), t.touchTimeout = setTimeout((function (e) {
                return t.cycle(e)
